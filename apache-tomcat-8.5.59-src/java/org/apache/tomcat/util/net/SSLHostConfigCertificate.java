...
public class SSLHostConfigCertificate implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        SSLHostConfigCertificate that = (SSLHostConfigCertificate) o;
        return Objects.equals(oname, that.oname) &&
                Objects.equals(sslContext, that.sslContext) &&
                Objects.equals(sslHostConfig, that.sslHostConfig) &&
                type == that.type &&
                Objects.equals(certificateKeyPassword, that.certificateKeyPassword) &&
                Objects.equals(certificateKeyAlias, that.certificateKeyAlias) &&
                Objects.equals(certificateKeystorePassword, that.certificateKeystorePassword) &&
                Objects.equals(certificateKeystoreFile, that.certificateKeystoreFile) &&
                Objects.equals(certificateKeystoreProvider, that.certificateKeystoreProvider) &&
                Objects.equals(certificateKeystoreType, that.certificateKeystoreType) &&
                Objects.equals(certificateKeystore, that.certificateKeystore) &&
                Objects.equals(certificateKeyManager, that.certificateKeyManager) &&
                Objects.equals(certificateChainFile, that.certificateChainFile) &&
                Objects.equals(certificateFile, that.certificateFile) &&
                Objects.equals(certificateKeyFile, that.certificateKeyFile) &&
                storeType == that.storeType;
    }

    @Override
    public int hashCode() {
        return Objects.hash(oname, sslContext, sslHostConfig, type, certificateKeyPassword, certificateKeyAlias, certificateKeystorePassword, certificateKeystoreFile, certificateKeystoreProvider, certificateKeystoreType, certificateKeystore, certificateKeyManager, certificateChainFile, certificateFile, certificateKeyFile, storeType);
    }
