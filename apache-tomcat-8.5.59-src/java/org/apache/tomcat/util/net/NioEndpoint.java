...
public class NioEndpoint extends AbstractJsseEndpoint<NioChannel> {
    ...
    public void bind() throws Exception {
        ...
        if (!getUseInheritedChannel()) {
            ...
            // Retrieve the channel provided by the OS  检索由OS提供的信道
        ...
        // Initialize thread count defaults for acceptor, poller  初始化线程数默认值受体，轮询
    ...
    /**
     * 后台线程，对于传入的TCP / IP连接和手它们关闭到一个适当的处理器监听
