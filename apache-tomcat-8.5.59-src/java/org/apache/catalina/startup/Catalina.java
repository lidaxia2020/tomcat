...
public class Catalina {
    ...
    /**
     * Set the shared extensions class loader. 设置共享的扩展类加载器。
     *
    ...
    /**
     * Return a File object representing our configuration file. 返回一个conf/server.xml对象
    ...
    protected Digester createStartDigester() {
        ...
        // Configure the actions we will be using  创建Server 实例
        ...
        // 为Service添加生命周期监听器 默认情况下未 Catalina未指定Service监听器
    ...
    public void load() {
        ...
        // Create and execute our Digester  创建映射关系
        ...
        // Start the new server 启动新服务器
        // 执行LifecycleBase.init() - 》 StandardServer.initInternal()
        try {
            getServer().init();
        } catch (LifecycleException e) {
    ...
    protected void initStreams() {
        // Replace System.out and System.err with a custom PrintStream 替换System.out和System.err的使用自定义的打印流
    ...
    /**
     * Set the security package access/protection. 设置安全包访问/保护
     */
